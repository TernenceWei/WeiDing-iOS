...
{
    if (self = [super initWithFrame:CGRectMake(0, 40, ScreenWidth, 216)])
    {
...
-(void)loadDefaultsParameters
{
    ...
    if (self.datePickerMode == DatePickerDateMode ) {
        ...
        [self selectDate:_defaultDate];
    }else if(self.datePickerMode == DatePickerYearMonthMode)
    {
        _defaultDate = [NSDate dateWithTimeIntervalSince1970:915120000];
        [self selectDate:_defaultDate];
    }
