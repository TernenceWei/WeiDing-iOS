...
-(void)createUI
{
    ...
    //[tableVC.tableView registerClass:[WL_SelectReceiver_ContactsCell class] forCellReuseIdentifier:kReuseId1];
...
-(void)sureButton:(UIButton *)button
{
    ...
    if ([[DEFAULTS objectForKey:@"adressbook"] isEqualToString:@"2"]) {
    ...
    }else if([[DEFAULTS objectForKey:@"adressbook"] isEqualToString:@"1"])
    {
        NSArray *arr= self.navigationController.viewControllers;
        WlLog(@"%@",arr);
