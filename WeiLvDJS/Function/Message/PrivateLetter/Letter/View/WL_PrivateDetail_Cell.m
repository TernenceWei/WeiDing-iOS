...
@implementation WL_PrivateDetail_Cell
...
+(CGFloat)heightWithModel:(WL_authorInfo_Model *)model
{
    ...
    WL_PrivateDetail_Cell *cell = [[WL_PrivateDetail_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@""];
