...

{
    ...
    UILabel *left =[[UILabel alloc]initWithFrame:CGRectMake(10, 0, 100, 44)];
    
    left.textColor = Color3;
    
    left.font = [UIFont WLFontOfSize:13];
...
//    }
    ...
    label.textColor = [WLTools stringToColor:@"#00cc99"];
