...
- (instancetype)initWithArray:(NSArray *)dataArray
{
    ...
    if (self) {
        [self setupDefault];
        [self setupUIWithDataArray:dataArray];
    }
    return self;
}
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:Color1 forState:UIControlStateNormal];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:Color1 forState:UIControlStateNormal];
