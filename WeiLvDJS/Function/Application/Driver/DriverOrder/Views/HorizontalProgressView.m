...
- (void)configElementsOnAbove:(BOOL)flag {
    ...
    for (NSInteger index = 0; index < [self.progressLevelArray count]; index++) {
        ...
        CGRect labelRect = CGRectMake(pointRect.origin.x + 5 + pointRadius - unitLineWidth / 2.0, labelOriginY, unitLineWidth, PROGRESS_TIPLABEL_HEIGHT);
...
- (void)generatePointWithFrame:(CGRect)frame
    ...
    if (achievedFlag && aboveFlag) {
        pointView.backgroundColor = self.achievedColor ? self.achievedColor : [UIColor colorWithRed:0 green:0.8 blue:0.6 alpha:0];
    } else {
...
- (void)generateUnitLineWithFrame:(CGRect)frame
    ...
    if (achievedFlag && aboveFlag) {
        lineView.backgroundColor = self.achievedColor ? self.achievedColor : [UIColor colorWithRed:0 green:0.8 blue:0.6 alpha:0];
    } else {
...
- (void)generateTipLabelWithFrame:(CGRect)frame
    ...
    if (achievedFlag && aboveFlag) {
        tipLabel.textColor = self.achievedColor ? self.achievedColor : [UIColor colorWithRed:0 green:0.8 blue:0.6 alpha:0];
    } else {
