//
//  WL_TradeRecord_ViewController_Cell.m
//  WeiLvDJS
//
...
@implementation WL_TradeRecord_ViewController_Cell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self =[super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.typeLabel =[WLTools allocLabel:@"提现" font:WLFontSize(15) textColor:WLColor(47, 47, 47, 1) frame:CGRectMake(12.5, 15, 50, 16) textAlignment:NSTextAlignmentLeft];
        ...
        self.dateLabel =[WLTools allocLabel:@"2016-12-02" font:WLFontSize(12) textColor:WLColor(111, 115, 120, 1) frame:CGRectMake(12.5, ViewBelow(self.typeLabel)+10, 200, 14) textAlignment:NSTextAlignmentLeft];
        ...
        self.line = [[UILabel alloc]initWithFrame:CGRectMake(0, 64.5, ScreenWidth, 0.5)];
...
-(void)setModel:(WL_TradeRecord_Model *)model
{
    ...
    if ([model.finance_type isEqualToString:@"1"]) {
        
        typeString = @"充值";
        
    }else if ([model.finance_type isEqualToString:@"2"])
    {
        typeString = @"提现";
        
    }else if ([model.finance_type isEqualToString:@"3"])
    {
        typeString = @"收款";
    }else if ([model.finance_type isEqualToString:@"4"])
    {
        typeString = @"付款";
    }
