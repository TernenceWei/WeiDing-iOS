...
//    }];
    ...
    WLCityItem *cityItem = provinceItem.cityItems[0];
    self.arrayArea = [self getStringArrayWithArray:cityItem.cityItems];
...
//        [pickerView selectRow:0 inComponent:2 animated:YES];
        ...
        self.arrayCity = [self getStringArrayWithArray:provinceItem.cityItems];
        WLCityItem *cityItem = provinceItem.cityItems[row];
        self.arrayArea = [self getStringArrayWithArray:cityItem.cityItems];
...
- (void)selectedOk
{
    ...
    WLCityItem *areaItem = cityItem.cityItems[self.index2];

    [self.delegate pickerArea:self province:self.province city:self.city area:self.area provinceID:provinceItem.cityID cityID:cityItem.cityID areaID:areaItem.cityID];
    [super selectedOk];
}
