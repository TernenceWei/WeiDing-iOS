...
@implementation WL_Comment_Cell
...
-(void)textViewDidChange:(UITextView *)textView
{
    ...
    if (self.commentTextView.text.length > 100)
    {
        ...
        [[WL_TipAlert_View sharedAlert]createTip:@"最多输入100个字"];
        
        self.commentTextView.text = [self.commentTextView.text substringToIndex:100];
