...
//  WeiLvDJS
//
//  Created by jyc on 2016/11/3.
//  Copyright © 2016年 WeiLvDJS. All rights reserved.
//

#import "WL_Warning_Window.h"

@interface WL_Warning_Window ()
...
@implementation WL_Warning_Window
...
-(void)setUp
{
    ...
    [knowButton setTitleColor:[WLTools stringToColor:@"#00cc99"] forState:UIControlStateNormal];
